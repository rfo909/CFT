...
public class ClientLoop implements Runnable {
    ...
    public ClientLoop (Stdio stdio, String addr, int port) {
        this.stdio=stdio;
        this.addr=addr;
        this.port=port;
    }
    ...
    public void run() {
        ...
        try {
            ...
            stdio.print(linePrefix); // initial linePrefix
            ...
            for (;;) {
                ...
                stdio.print(linePrefix); // following newline included in readLine
